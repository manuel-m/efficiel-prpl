...
export default function(conf_, controllers_) {
    var _encoding = conf_.encoding,
    ...
    _entry_point_to_controller_populate();

    return { request: _on_router_api_request };
    ...
    function _entry_point_to_controller_populate() {
        ...
        Object.keys(controllers_).forEach(function(key_) {
            var controller_ = controllers_[key_];
            ...
            _entry_point_to_controller_populate_by_method(
                controller_,
                'DELETE'
            );
        });
    ...
    function _entry_point_to_controller_populate_by_method(
        controller_,
        method_
    ) {
