...
function _home_view(context_) {
    var vm = context_.vm;
    return (
        (function () {
            var __, __h11, __ul2;
            __ = createElement('div', null, null);
            __h11 = createElement('h1', null, __);
            __h11.onclick = _home_message_onclick;
            __ul2 = createElement('ul', null, __);
            S(function (__current) { return content(__h11, vm.message(), __current); }, '');
            S(function (__current) { return content(__ul2, ['profile'].map(function(v_) {
                    return (
                        (function () {
                            var __, __button1;
                            __ = createElement('li', null, null);
                            __button1 = createElement('button', null, __);
                            content(__button1, v_, "");
                            S(function () { __button1.onclick = function() {
                                    context_.go(v_);
                                }; });
                            return __;
                        })()
...
var routes = { home: _home_view({ go: go, model: model, vm: vm }) };
