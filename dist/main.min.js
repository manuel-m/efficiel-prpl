...
function routerView(in_) {
    ...
    return (function () {
        ...
        S(function (__current) { return content(__, in_.routes[go()], __current); }, '');
        return __;
    })();
}
...
function _home_view(Surplus, context_) {
    var vm = context_.vm;
    return (
        (function () {
            var __, __h11, __ul2;
            __ = Surplus.createElement('div', null, null);
            __h11 = Surplus.createElement('h1', null, __);
            __h11.onclick = _home_message_onclick;
            __ul2 = Surplus.createElement('ul', null, __);
            Surplus.S(function (__current) { return Surplus.content(__h11, vm.message(), __current); }, '');
            Surplus.S(function (__current) { return Surplus.content(__ul2, ['profile'].map(function(v_) {
                    return (
                        (function () {
                            var __, __button1;
                            __ = Surplus.createElement('li', null, null);
                            __button1 = Surplus.createElement('button', null, __);
                            Surplus.content(__button1, v_, "");
                            Surplus.S(function () { __button1.onclick = function() {
                                    context_.go(v_);
                                }; });
                            return __;
                        })()
...
var model = {};
var vm = { clic: 0, route: '/', message: S.data('Click me') };
var routes = { home: _home_view(Surplus, { go: go, model: model, vm: vm }) };
