...
function _profile_view(context_) {
    return (
        (function () {
            var __, __pre1, __button2, __pre3;
            __ = createElement('div', null, null);
            __pre1 = createElement('pre', null, __);
            __pre1.textContent = "The profile view";
            __button2 = createElement('button', null, __);
            __pre3 = createElement('pre', null, __);
            S(function () {
                __button2.onclick = function() {
                    context_.go('home');
                };
                __button2.textContent = "Back";
            });
            S(function (__current) { return content(__pre3, JSON.stringify(context_, undefined, 1), __current); }, '');
            return __;
        })()
    );
}
...
var _app = shared();
var addonsRoutes = {
        profile: _profile_view({ go: _app.go, model: _app.model, vm: _app.vm })
    };
