...
function _profile_view(Surplus, context_) {
    return (
        (function () {
            ...
            Surplus.S(function (__current) { return Surplus.content(__pre3, JSON.stringify(context_, undefined, 1), __current); }, '');
            return __;
        })()
    );
}
...
var _app = shared();
var addonsRoutes = {
        profile: _profile_view(_app.Surplus, {
            go: _app.go,
            model: _app.model,
            vm: _app.vm
        })
